...
export const LaserHeroSection = () => {
    ...
    const linkList = {
        women: [
            ...
            'მთლიანი სხეული (ქალი)',
            'მთლიანი ხელები, ბრაზილიური და იღლიები',
            'იღლიები',
            'მთლიანი ფეხები',
            'მთლიანი ფეხები, ბრაზილიური და იღლიები',
        ],
        men: [
            ...
            <div className={styles.container}>
                ...
                <div className={styles.content}>
                    ...
                    <p className={styles.description}>
                        გადაყარე საპარსები. დაივიწყე ცვილი. <br />
                        ჩვენი სამედიცინო ხარისხის ლაზერული ეპილაცია განსხვავდება სხვა მეთოდებისგან —
                        ის სწრაფი, უსაფრთხო, ხელმისაწვდომი, ეფექტური და მუდმივი შედეგია. <br />
